...
public interface University {
	 ...
	 * 
	 * 
	 * 3-2)how many keywords are used for the inheritance in Interface, answer by Java
	 * comments Answer:One ,extends keywords Can an interface inherit other
	 ...
	 * inheritance is possible??Ans: Multiple interface to interface inheritance possible.
	 */
